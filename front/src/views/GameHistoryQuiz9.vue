    ...
    <div class="game-quiz__wrap-content">
      ...
      <div class="game-quiz__actions">
        ...
        <div class="game-quiz__wrap-next">
          ...
          <router-link to="/game/history/quiz9" class="game-quiz__next-quiz-btn btn btn-main">Île suivante</router-link>
        </div>
      </div>      

    </div>
    <div data-hearts-container class="hearts"></div>
  </div>
</template>
  ...
  export default {
    ...
    methods:{
      ...
      quizValidate() {
        ...
        document.querySelector('.game-quiz__traking').classList.remove('active');
        document.querySelector('.game-quiz__validate-btn').classList.remove('active');
